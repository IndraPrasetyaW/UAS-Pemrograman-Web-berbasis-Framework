...
/**
 * FakultasController implements the CRUD actions for Prodi model.
 */
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new Fakultas",
                    'content'=>'<span class="text-success">Create Fakultas success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-bs-dismiss'=>"modal"]).
